...
HD_PWD='C:/dev/fpga_proj/_mini/calculator/adder_axi4_project/adder_axi4_project.runs/design_1_adder_axi4_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adder_axi4_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adder_axi4_top_0_0.tcl
