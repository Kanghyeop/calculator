...
HD_PWD='C:/dev/fpga_proj/_mini/calculator/adder_axi4/adder_axi4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_axi4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_axi4_top.tcl
