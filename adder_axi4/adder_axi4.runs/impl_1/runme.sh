...
HD_PWD='C:/dev/fpga_proj/_mini/calculator/adder_axi4/adder_axi4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_axi4_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_axi4_top.tcl -notrace
